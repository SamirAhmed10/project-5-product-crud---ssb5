        ...
        <div class="row">
          <div class="col-lg-6">
              <div class="form-group">
                 <label>Product</label>
                 <input type="text" class="form-control"  name="name" placeholder="Enter Product " required="required" autocomplete="off">
              </div>
           <div class="form-group">
                   ...
                   @endif
                    ...
                    @php $j=0; @endphp
                     ...
                     @endforeach
                        ...
                        @if($i==$j)
                           ...
                           <option value="{{ $cat->id }}">{{$ca->name}}->{{$cat->name}}
                           </option>
                        @endif
                    ...
                    @php $l=0; @endphp
                     ...
                     @php $c = $k++; @endphp
                        ...
                        @if($c==$d)
                           ...
                           <option value="{{ $child->id }}">{{$ca->name}}->{{$cat->name}}->{{$child->name}}
                           </option>
                        @endif
                     ...
                     @php $e = $m++; @endphp
                      ...
                      @endforeach
                        ...
                        @if($e==$f)
                           ...
                           <option value="{{ $chi->id }}">{{$ca->name}}->{{$cat->name}}->{{$child->name}}->{{$chi->name}}
                           </option>
                        @endif
                     ...
                     @endforeach
                        ...
                        @if($q==$r)
                     <option value="{{ $ch->id }}">{{$ca->name}}->{{$cat->name}}->{{$child->name}}->{{$chi->name}}->{{$ch->name}}
                     </option>
                     @endif
                     <!-- sub category5 -->
                    ...
                    @php $v=0; @endphp
                     ...
                     @endforeach
                        ...
                        @if($u==$v)
                     <option value="{{ $c->id }}">{{$ca->name}}->{{$cat->name}}->{{$child->name}}->{{$chi->name}}->{{$ch->name}}->{{$c->name}}
                    </option>
                    @endif
             ...
             <div class="form-group">
                 ...
                 <input type="text" class="form-control"  name="quantity" placeholder="Enter Product Quantity" required="required" autocomplete="off">
              </div>
              <div class="form-group">
                 <label>Product price</label>
                 <input type="text" class="form-control"  name="price" placeholder="Enter Product price" required="required" autocomplete="off">
              </div>
              <div class="form-group">
                 <label>Product offer price [Optional]</label>
                 <input type="text" class="form-control"  name="offer_price" placeholder="Enter Product Offer Price"  autocomplete="off">
              </div>
          ...
          <div class="col-lg-6">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control" name="specification" rows="5"></textarea>
               </div>
               <div class="container">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $("body").on("click",".btn-remove",function(){ 
          ...
          <div class="col-lg-12">
            <div class="form-group">
               <input type="submit" name="addproducts" value="Save" class="btn btn-dark  mg-b-10">
            </div>
          </div>
       </div>
      </form>
